...
def remove_present(input_arr):
    ...
    if input_arr is not None and len(input_arr) > 0:
        ...
        try:
            payload = {
                'auction_type': 'copart',
                'lot_numbers': flat_lot_numbers
            }
            response = requests.post(check_if_present_url, json=payload, timeout=120)
    ...
    for veht_item in veht_array:
        ...
        if number_of_lots <= 1000:
            ...
            for brand in brand_array:
                ...
                send_to_api(brand_description, vehtype)
...
def main():
    ...
    # #tmp
    # # table_name = f"copart_lots_veht_f"
